...
[SelectionBase]
public class MainSquare : Square, IEndDragHandler, IDragHandler, IBeginDragHandler{
    ...
    //Kierunek swipe'a na ekranie, dla urządzeń mobilnych
	...
	public override void Start () {
        ...
        swipeControls = gameObject.GetComponent<Swipe>();
	}
    ...
    public override void Update()
    {
        ...
        {
            if ((Input.GetKeyDown(KeyCode.UpArrow) || swipeControls.SwipeUp ) && topSquare != null)
                Move(MoveDirection.Up);
            else if ((Input.GetKeyDown(KeyCode.RightArrow) || swipeControls.SwipeRight) && rightSquare != null)
                Move(MoveDirection.Right);
            else if ((Input.GetKeyDown(KeyCode.DownArrow) || swipeControls.SwipeDown) && bottomSquare != null)
                Move(MoveDirection.Down);
            else if ((Input.GetKeyDown(KeyCode.LeftArrow) || swipeControls.SwipeLeft) && leftSquare != null)
    ...
    /// <summary>
    /// Funkcja wykrywająca swipe, dla urządzeń mobilnych
    /// </summary>
